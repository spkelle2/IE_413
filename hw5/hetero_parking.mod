...
Name:             P
Description:      
State Changes:    TIME[X]=TIME[X]+CLK-PREVCLK,X=X+1,PREVCLK=CLK
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
...
Origin:        A
Destination:   A
Condition:     RND>(MOD{CLK;3600}-16*60>120)*(1-2.6/3.2)
Delay:         -60/3.2*LN{1-RND}
Priority:      5
Attributes:    
